...
export class InitMigrations1742665638918 implements MigrationInterface {
    name = 'InitMigrations1742665638918'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "email_confirmation_to_user" ADD CONSTRAINT "PK_e313c3be9d6ffd32b0d35607445" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "email_confirmation_to_user" ADD CONSTRAINT "PK_8119912ce15961cb79a1215218c" PRIMARY KEY ("id", "user_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "recovery_password_to_user" ADD CONSTRAINT "PK_65931e2851b04c42a88b7d5fb80" PRIMARY KEY ("user_id")`);
